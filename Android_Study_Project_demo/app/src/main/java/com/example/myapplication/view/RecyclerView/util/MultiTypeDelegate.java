package com.example.myapplication.view.RecyclerView.util;
...
import static com.example.myapplication.view.RecyclerView.adapter.BaseMultiItemQuickAdapter.TYPE_NOT_FOUND;
